...
export function render(vnode: VNode | null, container: HostContainer) {
  // TODO: patch against container._vnode and unmount when vnode is null.
...
function patch(
  ...
  // TODO: replace incompatible type/key identities before dispatching.
...
function patchElement(oldVNode: VNode, newVNode: VNode) {
  // TODO: reuse oldVNode.el, patch props in both directions, and patch children.
...
function patchChildren(oldVNode: VNode, newVNode: VNode, container: HostElement) {
  // TODO: handle text, array, and empty transitions without leaking old trees.
  void oldVNode;
  void newVNode;
  void container;
}
...
function processComponent(
  ...
  // TODO: preserve an instance and patch its previous and next subtrees.
  if (!oldVNode) {
...
function patchKeyedChildren(oldChildren: VNode[], newChildren: VNode[], container: HostElement) {
  // TODO: match by type/key, remove missing nodes, and mount or move into final order.
