  ...
  <main class="settings">
    ...
    <nav class="tabs" aria-label="Secciones de configuración">
      ...
      <button
        ...
        :aria-pressed="currentTab === 'security'"
    ...
    <section class="tab-content">
      <!-- TODO: renderiza tabs[currentTab] con un componente dinámico. -->
      <!-- TODO: usa KeepAlive para conservar el estado al cambiar de pestaña. -->
    </section>
  </main>
</template>
