...
<template>
  <div class="security-settings">
    <h2>Security</h2>
    <label><input v-model="twoFactor" data-testid="two-factor" type="checkbox" /> Two-factor authentication</label>
    <button data-testid="toggle-recovery" type="button" @click="showRecoveryCodes = !showRecoveryCodes">Show recovery codes</button>
