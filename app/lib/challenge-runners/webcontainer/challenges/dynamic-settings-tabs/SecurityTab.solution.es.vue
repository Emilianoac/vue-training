...
<template>
  <div class="security-settings">
    <h2>Seguridad</h2>
    <label><input v-model="twoFactor" data-testid="two-factor" type="checkbox" /> Autenticación en dos pasos</label>
    <button data-testid="toggle-recovery" type="button" @click="showRecoveryCodes = !showRecoveryCodes">Mostrar códigos de recuperación</button>
    <div v-show="showRecoveryCodes" data-testid="recovery-codes" class="recovery-codes"><code>VUE-2026</code><code>KEEP-ALIVE</code></div>
  </div>
</template>
