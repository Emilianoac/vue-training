...
<template>
  <nav
    class="w-full m-0 bg-white dark:bg-slate-900 text-black dark:text-white border border-gray-100 dark:border-slate-800 rounded-tl-md rounded-tr-md shadow-md bottom-0 sticky right-0 left-0 block md:hidden z-[999]"
  >
    <div class="flex items-center justify-between container mx-auto p-2">
      ...
      >
        <component :is="menuItem.meta.icon" width="18" height="18" class="mx-auto" />
