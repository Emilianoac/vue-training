...
<template>
  <div>
    ...
    <div
      class="flex flex-col-reverse md:grid grid-cols-[1fr_0.6fr] bg-slate-100 dark:bg-slate-800/50 border dark:border-slate-800 border-slate-200 rounded-lg overflow-hidden"
    >
      ...
      <div>
        <div
          class="bg-slate-200 dark:bg-slate-800/50 flex justify-center items-center w-full h-full p-4"
        >
          <img
