...
<template>
  <div class="flex items-center justify-end my-3">
    <button
      ...
      :title="
        expandeEditor ? $t('challenge.play.collapse_editor') : $t('challenge.play.expand_editor')
      "
    ...
    <div v-if="!expandeEditor">
      ...
      <template v-if="objectives">
        <h2 class="font-bold text-gray-900 dark:text-white mb-2">
          {{ $t("challenge.description.objectives") }}
        </h2>
        <ul
      ...
      <p class="text-sm">
        ...
        <code
          class="bg-gray-200 dark:bg-gray-800 dark:text-gray-300 p-1 rounded-md whitespace-nowrap"
